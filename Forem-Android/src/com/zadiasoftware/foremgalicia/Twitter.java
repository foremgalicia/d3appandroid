...
public class Twitter extends GDListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		thread.start();
		m_ProgressDialog = ProgressDialog.show(Twitter.this, getResources()
	...
	private void insertaActionBar() {
		// actionbar
		getActionBar().setTitle(getResources().getString(R.string.twitter));
		...
		public void run() {
			if (recursos != null && recursos.size() > 0) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(
						Twitter.this);
				builder.setMessage(R.string.notwitter)
						.setCancelable(true)
	...
	private void getRecursos() {
		try {
			...
			recursos = (ArrayList<RSS>) XMLReader.getTweets();
	...
	private class TweetAdapter extends ArrayAdapter<RSS> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (o != null) {
				...
				if (tt != null)
					tt.setText(o.description.replace("proxectodesire: ", ""));
				ImageView img = (ImageView) v.findViewById(R.id.icono);
				if (img != null)
					img.setImageResource(R.drawable.elearning);
			}
